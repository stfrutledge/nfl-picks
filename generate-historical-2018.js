// Script to generate historical-2018.js from ESPN data and Google Sheets picks
// Run with: node generate-historical-2018.js

const https = require('https');
const http = require('http');

const SHEET_ID = '1ffUPuq3eLEdfVUq9s6v6eF_wNZk1Gu7RCmmMIVy1zIY';
...
async function fetchESPNWeek(week) {
    const url = `https://site.api.espn.com/apis/site/v2/sports/football/nfl/scoreboard?seasontype=2&week=${week}&dates=2018`;
    try {
...
async function main() {
    ...
    const fileContent = `// NFL Picks 2018 Season Historical Data
// Generated from Google Sheets data
// Pickers: ${PICKERS.join(', ')}

window.SEASON_2018_DATA = ${JSON.stringify(output, null, 2)};
`;

    require('fs').writeFileSync('historical-2018.js', fileContent);
    console.log('\nGenerated historical-2018.js');
}
