// Script to generate historical-2019.js from ESPN data and Google Sheets picks
// Run with: node generate-historical-2019.js

const https = require('https');
const http = require('http');

const SHEET_ID = '170VZc209yrc81h8FayhNt4L-sUbmgVcwzu8RypV0lDA';
const PICKERS = ['Stephen', 'Sean', 'Dylan'];

// GIDs for each picker's weekly tabs
const PICKER_GIDS = {
    Stephen: {
        1: 1878178638, 2: 2060494086, 3: 1141244636, 4: 143155454,
        5: 1922884710, 6: 1678755920, 7: 1647294341, 8: 986604477,
        9: 1846491693, 10: 1821063495, 11: 645829444, 12: 1401214109,
        13: 656598239, 14: 990568095, 15: 1141771236, 16: 421149404,
        17: 32310395
    },
    Sean: {
        1: 376951461, 2: 113715741, 3: 1761196737, 4: 473830917,
        5: 174270680, 6: 491045632, 7: 1823453613, 8: 2139430256,
        9: 236960675, 10: 1156857336, 11: 1109743533, 12: 1892061268,
        13: 1432579103, 14: 1908503268, 15: 1115324123, 16: 1496766442,
        17: 487839011
    },
    Dylan: {
        1: 589863118, 2: 1029646408, 3: 1572583114, 4: 1167937411,
        5: 811385841, 6: 1325161903, 7: 1875357747, 8: 140111826,
        9: 1518591668, 10: 1873122315, 11: 144129811, 12: 127367278,
        13: 1417338383, 14: 1574755881, 15: 201843205, 16: 2106939138,
        17: 1573659497
    }
};
...
const TEAM_NAME_MAP = {
    ...
    'TB': 'Buccaneers', 'Tampa Bay': 'Buccaneers', 'Tampa Bay Buccaneers': 'Buccaneers', 'Buccs': 'Buccaneers',
...
async function fetchESPNWeek(week) {
    const url = `https://site.api.espn.com/apis/site/v2/sports/football/nfl/scoreboard?seasontype=2&week=${week}&dates=2019`;
    try {
...
async function main() {
    ...
    const fileContent = `// NFL Picks 2019 Season Historical Data
// Generated from Google Sheets data
// Pickers: ${PICKERS.join(', ')}

window.SEASON_2019_DATA = ${JSON.stringify(output, null, 2)};
`;

    require('fs').writeFileSync('historical-2019.js', fileContent);
    console.log('\nGenerated historical-2019.js');
}
